      ...
      <main className="flex-1 container py-8">
        ...
        {!isServiceAvailable && (
          <Alert variant="destructive" className="mb-6">
            ...
            <AlertDescription>
              El servicio de favoritos no está disponible. No se pueden cargar tus favoritos en este momento. Por favor,
              inicia el microservicio de favoritos con el comando:{" "}
              <code className="bg-gray-100 px-1 py-0.5 rounded">
                cd microservices/favorites-service && node server.js
              </code>
            </AlertDescription>
          </Alert>
        )}
